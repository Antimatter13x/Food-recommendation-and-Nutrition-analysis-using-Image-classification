...
import in.cip.tensor_image_classification.classifier.ImageClassifier;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(Object x : list)
                    ing.append((x)+"+");
                Intent send = new Intent(MainActivity.this, recipe.class);
                send.putExtra("Ingredients", ing.toString().substring(0,ing.lastIndexOf("+")));
                startActivity(send);
